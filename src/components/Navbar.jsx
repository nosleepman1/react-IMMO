...
const Navbar = () => {
    ...
    const Menu = [
        {name: 'accueil', path: '/'}, {name: 'accueil', path: '/'}, {name: 'accueil', path: '/'}, {name: 'accueil', path: '/'}
    ]
           ...
           {/**ici lelogo */}
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                <div className="relative cursor-pointer">
                    ...
                    <button className="absolute -top-2 -right-3 text-xs text-white bg-indigo-500 w-[18px] h-[18px] rounded-full">10</button>
                </div>
